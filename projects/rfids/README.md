# Описание
Плата использует свои 2 UART интерфейса для сканирования 10 ти модулей RDM6300 (125 kHz RFID). На сканирование одного канала уходит 250 мс, при параллельной работе UART получаем 5 пар каналов и 1250 мс на цикл. Но в реальности немного плавает.\
...
# Проблемы
1. Метки отличаются друг от друга, одни читаются быстрее, другие медленнее, отчего при сканировании всех каналов, можно не обнаружить метку, хотя она там расположена. Помогло изменение чтения одного канала с 160 мс до 250 мс.