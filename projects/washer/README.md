...
## Точки для получения команд:
- /washer/**ID**/play - запускает проигрывание мелодии, данные не важны
- /washer/**ID**/stop - останавливает проигрывание мелодии, данные не важны
- /washer/**ID**/signal - запускает короткий сигнальный гудок, данные не важны
- /washer/**ID**/set_value - устанавливает текущее значение циферблата, внутри JSON: {"value" : int}, где int значение [0; 999]
- /washer/**ID**/set_target - устанавливает значение которое необходимо ввести, при его достижении отправит уведомление. Внутри JSON: {"value" : int}, где int значение [0; 999]

## Точки куда отправляет свои данные:
- /washer/**ID**/updates - отправляется сюда в случаи достижения значения равному необходимому value = target, внутри JSON: {"value": int}, где int значение target
